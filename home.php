                                        ...
                                        <div class="card-item">
                                            ...
                                            <div class="card-item-options">
                                                ...
                                                <ul class="card-item-dropdown">
                                                    <li class="card-item-dropdown-item card-item-dropdown-item-modify"><a class="dropdown-modify-item-home" href="http://localhost:8088/Project_web/modify.php?token=$token">Modify</a></li>
                                                    <li class="card-item-dropdown-item card-item-dropdown-item-remove"><a class="dropdown-modify-item-home" href="http://localhost:8088/Project_web/remove.php?token=$token">Remove</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
